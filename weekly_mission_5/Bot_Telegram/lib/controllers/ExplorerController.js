...
class ExplorerController{
    ...
    static getExplorersUsernamesByMission_String(mission){
        const explorers = Reader.readJsonFile("explorers.json")
        const explorersInNodeToGetUsernames = ExplorerService.getExplorersUsernamesByMission_String(explorers, mission);
        return explorersInNodeToGetUsernames
    }
